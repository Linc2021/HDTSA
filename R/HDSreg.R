...
#' @param D A \eqn{p\times m} data matrix means the regression coefficient matrix \eqn{{\bf D}}. Default is \code{NULL}, if \code{D} is not given, then the function will estimate it.

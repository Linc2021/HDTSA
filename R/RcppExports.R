...
TnC_mat <- function(n, L, Vep) {
    .Call('_HDTSA_TnC_mat', PACKAGE = 'HDTSA', n, L, Vep)
}

WN_ftC_mat <- function(n, L, p, M, Vep) {
    .Call('_HDTSA_WN_ftC_mat', PACKAGE = 'HDTSA', n, L, p, M, Vep)
}

WN_bandwith_mat <- function(ft, n, L, p, M, ken_type) {
    .Call('_HDTSA_WN_bandwith_mat', PACKAGE = 'HDTSA', ft, n, L, p, M, ken_type)
}

newbootC_kernel_mat <- function(n, L, p, M, B, bn, method, Vep, Xi_temp) {
    .Call('_HDTSA_newbootC_kernel_mat', PACKAGE = 'HDTSA', n, L, p, M, B, bn, method, Vep, Xi_temp)
}

TnC_vec <- function(n, L, Vep) {
    .Call('_HDTSA_TnC_vec', PACKAGE = 'HDTSA', n, L, Vep)
}

WN_bandwith_vec <- function(Vep, n, L, p, M, ken_type) {
    .Call('_HDTSA_WN_bandwith_vec', PACKAGE = 'HDTSA', Vep, n, L, p, M, ken_type)
}

newbootC_kernel_vec <- function(n, L, p, M, B, bn, method, Vep, Xi_temp) {
    .Call('_HDTSA_newbootC_kernel_vec', PACKAGE = 'HDTSA', n, L, p, M, B, bn, method, Vep, Xi_temp)
}
